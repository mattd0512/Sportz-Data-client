...
const NhlGameShow = (props) => {

    const [nhlGames, setGameNhl] = useState([])
                        ...
                        <Col style={col1Style}>
                            <Card style={cardCSS}>
                                ...
                                <h5 class="card-title">Upcoming Matchups</h5>
                                    <h4 style={boldText}>{nhlGame.conference}</h4>
                                </Card.Header>
                                <Card.Body>
                                    <Card.Text>
                                        {nhlGames.map((result) => (
